...
public abstract class AbstractStorageTest {
    ...
    public void setUp() throws Exception {
        ...
        storage.save(new Resume(UUID_2, "fullName1"));
        storage.save(new Resume(UUID_3, "fullName1"));
    }
    ...
    public void get() throws Exception {
        Resume testResume = new Resume(UUID_1, "fullName");
        Assert.assertEquals(new Resume(UUID_1, "fullName"), storage.get(testResume.getUuid()));
    }
    ...
    public void getAllSorted() {
        List<Resume> assertEquals = Arrays.asList(new Resume(UUID_1), new Resume(UUID_2), new Resume(UUID_3));
